...
ccs_build_target = os.getenv("ENV_CCS_BUILD_TARGET")
ccs_binary_name = os.getenv("ENV_PROJECT_OUT_FILE")
...
out_binary_path = os.path.join(ccs_project_dir, ccs_build_target, ccs_binary_name)
print("Flash binary file: " + out_binary_path)
session.memory.loadProgram(out_binary_path)
